/* Version: 0.0.9 - October 26, 2023 06:07:36 */
// ==UserScript==
    ...
    ***************************************************************************** */
    ...
    (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            request = _a.sent();
                            if (!"".concat(args[0]).match(/^https:\/\/nv-?comment\.nicovideo\.jp\/v1\/threads$/)) return [3, 3];
        ...
        var setup = function () { return __awaiter(_this, void 0, void 0, function () {
            var player, CommentRenderer, commentCanvas, eventHandlerCanvas, iframe;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, getElement("VideoContainer")];
                    case 1:
                        player = (_b.sent())[0];
                        if (!player)
                            throw new Error("failed to get player element");
                        CommentRenderer = player.getElementsByClassName("CommentRenderer")[0];
                        if (!CommentRenderer)
                            throw new Error("failed to get CommentRenderer element");
                        commentCanvas = CommentRenderer.getElementsByTagName("canvas")[0];
                        if (!commentCanvas)
                            throw new Error("failed to get commentCanvas element");
                        eventHandlerCanvas = player.getElementsByClassName("VideoSymbolContainer-canvas")[0];
                        ...
                        iframe.setAttribute("style", "position: absolute;left: 0;top: 0; width: 100%; height: 100%;border: none;");
